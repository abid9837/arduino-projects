...
digitalWrite(relay8, LOW); //Swtich relay2 off
  pinMode(6,OUTPUT);  // ultrasonic tring pin set arduino 6 pin
  pinMode(7,INPUT);  //  ultrasonic echo pin set arduino 7 pin
  motor.attach(12); //motor midle left   // motor midle 5v,, motor midle right gnd
